...
class YxActivity : AppCompatActivity() {
    ...
    private fun createOrdinanceItems() {
        ...
        val ordinances = listOf(
            ...
            "• 本人对自身婚姻事务拥有绝对且排他的最终决定权。是否结婚、与谁结婚、何时结婚均由本人独立判断，坚决反对任何第三方（包括但不限于亲属、伴侣、社会习俗及任何形式的权威）进行干涉、胁迫或施加不当影响。",
            "• 严禁一切形式的占卜、算命、宗教及封建迷信活动与信仰。坚持理性与实证两大原则，拥抱不确定性，接纳未知，重视过程。违者罚跑800米一圈，20个引体向上，罚款1000元，通读《黑格尔法哲学批判导言》一遍。",
            "• 坚持丁克主义，永久性禁止生育后代，违者罚款200000元，罚跑2次1200米，3组20个引体向上。",
            "• 永久性彻底禁止一切投机行为（任何以短期价差收益为目标的交易行为，其决策基于技术分析、情绪、新闻、感觉）与赌博行为（任何押注于随机性或不确定结果，以图利用运气获取收益的行为），违者罚跑2次1200米，2组20个引体向上，40个仰卧起坐，通读《GML基本法》10遍。",
            "• 严禁购买任何加密货币、稳定币、NFT、各类代币等链上资产，但允许被动接受链上资产并卖出为法币。违者罚跑2次1200米，3组20个引体向上，通读《基本法》10遍。",
            "• 严禁以任何形式、任何名义为任何第三方（包括但不限于亲属、朋友、同事及任何法律实体）的债务提供担保、增信或承诺承担连带责任。\"担保\"包括但不限于 签署保证合同、抵押/质押合同、出具承诺函/安慰函、提供差额补足承诺、回购承诺、流动性支持承诺等一切可能产生法律担保责任的书面或口头形式。违者罚跑1次1200米，2组20个引体向上，40个仰卧起坐，通读《GML基本法》及《GML借款合同框架》全文三遍。",
            "• 原则上严禁借入资金（包括但不限于从金融机构、个人、平台获得的一切有息/无息借款；使用信用卡、消费贷、现金贷、信用支付产品（如花呗、白条、度小满）所产生的一切负债）。仅当面临生存必需且自身及\"北岸金\"均无法覆盖时，方可借入，但单次借入金额不得超过上月基本生活费的2倍。仅当直系亲属（仅限奶奶、父母）病危时，可启动紧急借款，累计总额不得超过上一年度个人税后总收入的2倍。违者罚跑1次1200米，40个仰卧起坐。",
            "• 原则上严禁借出资金，如确有必要，出借行为应视为可能无法收回的赠予，做好心理与财务准备。若单笔出借金额超过自身月收入的2倍，必须签订《GML借款合同框架》书面合同，明确约定借款利率、期限、抵押物（若有）及违约条款。无合同，即违规。违者罚跑800米一圈，10个引体向上，罚款1000元。",
            "• 生活费仅可用于保障生活及应对紧急情况，严禁将其用于任何形式的投资、投机、出借。该笔资金仅可存放于银行活期/定期存款、国债逆回购、货币基金，严禁存入链上钱包与加密交易所，严禁将生活费用于任何要求预付保证金、解冻金的\"交易\"。 违者罚跑2次1200米，2组20个引体向上，通读《基本法》10遍。",
            "• 坚决维护个人财产所有权及绝对处分权，禁止让渡于他人（包括但不限于配偶、亲属）。违者罚跑1200米一圈，20个引体向上。",
            "• 严禁吸烟、吸毒。违者罚款10000元，罚跑2次1200米，3组20个引体向上。",
            "• 严禁在国内平台发表任何可能被认定为煽动分裂、颠覆或传播严重谣言的内容。发表任何争议性言论前，必须评估其法律风险！违者罚款500元，强制断网5小时，通读《基本法》5遍，罚跑500米，50个仰卧起坐。",
            "• 严禁在婚姻关系存续期间出轨、嫖娼。违者罚跑2次1200米，2组20个引体向上，20个仰卧起坐，罚款10000元。",
            "• 禁止购买任何游戏内虚拟物品、代币或服务（即禁止\"游戏充值\"），违者罚跑800米，20个仰卧起坐，强制断网5小时。",
            "• 严禁在任何网络平台，进行\"打赏\"、\"刷礼物\"、\"充电\"等付费活动，违者罚跑1000米，40个仰卧起坐，强制断网5小时。"
        )
